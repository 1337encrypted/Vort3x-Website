...
After successfully logging in, visit the Level 1 section to learn how to progress to the next level.
...
in the main folder.
Utilize this passphrase for accessing Level 0x02 via SSH.
...
'Level 0x02':`
The passphrase for advancing to the subsequent level can be found within a document named <strong>"-"</strong>
located in the main directory.

<h3>Commands that might be useful for completing this level include</h3>
<a href="https://www.geeksforgeeks.org/ls-command-in-linux/">ls</a>, <a href="https://www.geeksforgeeks.org/cd-command-in-linux-with-examples/">cd</a>, <a href="https://www.geeksforgeeks.org/cat-command-in-linux-with-examples/">cat</a>, <a href="https://www.geeksforgeeks.org/file-command-in-linux-with-examples/">file</a>, <a href="https://www.geeksforgeeks.org/du-command-linux/">du</a>, <a href="https://www.geeksforgeeks.org/find-command-in-linux-with-examples/">find</a>.
...
'Level 0x03':`
The passphrase for accessing the next level can be found within a hidden file within the <strong>inhere</strong> directory.

<h3>Commands potentially useful for navigating this stage include</h3>
<a href="https://www.geeksforgeeks.org/ls-command-in-linux/">ls</a>, <a href="https://www.geeksforgeeks.org/cd-command-in-linux-with-examples/">cd</a>, <a href="https://www.geeksforgeeks.org/cat-command-in-linux-with-examples/">cat</a>, <a href="https://www.geeksforgeeks.org/file-command-in-linux-with-examples/">file</a>, <a href="https://www.geeksforgeeks.org/du-command-linux/">du</a>, <a href="https://www.geeksforgeeks.org/find-command-in-linux-with-examples/">find</a>.`,

'Level 0x04':`
The passphrase for advancing to the subsequent level is located in the sole file that is readable by
humans within the <strong>inhere</strong> directory.

<h3>Commands that might be beneficial for completing this level include</h3>
<a href="https://www.geeksforgeeks.org/ls-command-in-linux/">ls</a> ,<a href="https://www.geeksforgeeks.org/cd-command-in-linux-with-examples/">cd</a> ,<a href="https://www.geeksforgeeks.org/cat-command-in-linux-with-examples/">cat</a> ,<a href="https://www.geeksforgeeks.org/file-command-in-linux-with-examples/">file</a> ,<a href="https://www.geeksforgeeks.org/du-command-linux/">du</a> ,<a href="https://www.geeksforgeeks.org/find-command-in-linux-with-examples/">find</a>.

<p id=hint>Hint: should your terminal display errors, consider using the "reset" command.</p>`,

'Level 0x05':`
The passphrase for progressing to the next level can be found in a file within the <strong>inhere</strong> directory
...
'Level 0x06': `
The passphrase for accessing the subsequent level is located somewhere on the server and meets the 
following criteria:
- Owned by user shell07
- Belongs to group Level0x05
- Size of 33 bytes
...
'Level 0x07':`
The passphrase for advancing to the next level is located in the file data.txt next to the term <strong>millionth</strong>

<h3>Commands that might be useful for solving this level include:</h3>
